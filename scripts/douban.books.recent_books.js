...
window["DOUBAN"]["BOOKS"]["SEARCHBOOKS"] = function(recent_book_el) {
    this.act_with = function(books_for_individual) {
        if (books_for_individual.size() == 0) return;
        ...
        var people_icon_section = $("#search-template").tmpl(contact);
        var book_element = $("#search-books-template").tmpl(books);
